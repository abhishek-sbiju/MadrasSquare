  ...
  return (
    <section className="px-6 md:px-14 lg:px-24 py-24 md:py-32 bg-card">
      <div className="max-w-3xl mx-auto text-center">
        <p className="text-gold text-[10px] md:text-xs tracking-[0.4em] font-body mb-3 uppercase">About Us</p>
        <h2 className="font-heading text-3xl md:text-5xl font-bold text-foreground mb-5 leading-tight tracking-wide">
        ...
        <p className="text-gold text-[10px] md:text-xs tracking-[0.4em] font-body mb-3 uppercase">Discover</p>
        ...
        <p className="font-heading italic text-gold-light text-base md:text-lg mt-12 tracking-wide">Made with warmth and care</p>
      </div>
    </section>
  );
};
