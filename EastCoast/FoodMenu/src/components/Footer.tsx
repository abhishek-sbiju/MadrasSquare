...
const Footer = () => {
  return (
    <footer className="bg-black/40 border-t border-white/[0.05] mt-16 pt-16 pb-8 px-6 md:px-12 lg:px-20 text-center md:text-left">
      ...
      <div className="max-w-7xl mx-auto pt-8 border-t border-white/[0.05] flex flex-col md:flex-row items-center justify-between gap-4 font-body text-[11px] text-muted-foreground/50 tracking-wide">
