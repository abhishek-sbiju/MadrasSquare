  ...
  return (
    <section className="px-4 md:px-8 lg:px-16 py-16 md:py-24 bg-card">
      <div className="max-w-3xl mx-auto text-center">
        <p className="text-amber/60 text-xs tracking-[0.3em] font-body mb-2 uppercase">About Us</p>
        ...
        <p className="text-amber/60 text-xs tracking-[0.3em] font-body mb-2 uppercase">Discover</p>
