...
export const menuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Fried Chicken / Lamb Bolognese Fries", price: "₹460 / ₹500", description: "Crispy fries, melty cheese sauce and chicken / lamb bolognese", tags: ["new"], dietType: "non-veg" },
    ],
  },
  {
    id: "sushi",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Chicken, Corn and Broccoli", price: "₹580", description: "Chicken, corn and broccoli baked in a creamy sauce gratinee served with garlic herb rice and garlic bread", dietType: "non-veg" },
      ...
      { name: "Lamb Lasagna", price: "₹780", description: "Layered pasta with lamb bolognese baked with mozzarella and garlic bread", dietType: "non-veg" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Callebaut Brownie", price: "₹240", description: "Warm dark chocolate chip brownie topped with flaky sea salt", dietType: "veg" },
