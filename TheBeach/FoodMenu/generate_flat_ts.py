...
export const menuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    description: "Pizza Add ons: Mushrooms / Vegetables ₹100 · Olives / Jalapenos ₹80 · Chicken / Cheese ₹150 · Bacon / Prawn / Pepperoni ₹200",
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Shrimp and Mascarpone Ravioli", price: "₹650", description: "Minced shrimp, shallots, garlic, chilli, cilantro and mascarpone in marie rose sauce", tags: ["seafood"], dietType: "non-veg" },
  ...
  },
  {
    ...
    title: "BEVERAGES",
    items: [
      { name: "Orange Juice", price: "₹400", dietType: "veg" },
      { name: "Watermelon Juice", price: "₹350", dietType: "veg" },
      { name: "Orange / Litchi Juice", price: "₹200", dietType: "veg" },
      { name: "Cranberry / Guava Juice", price: "₹250", dietType: "veg" },
      { name: "Apple / Pineapple Juice", price: "₹200", dietType: "veg" },
      ...
      { name: "Peach Iced Tea", price: "₹340", dietType: "veg" },
      { name: "Litchi Iced Tea", price: "₹340", dietType: "veg" },
      { name: "Lemon Iced Tea", price: "₹340", dietType: "veg" },
      ...
      { name: "Vanilla / Chocolate / Strawberry Milkshake", price: "₹380", dietType: "veg" },
      { name: "Cookies And Cream Milkshake", price: "₹380", dietType: "veg" },
      { name: "Nutella Milkshake", price: "₹420", dietType: "veg" },
      { name: "Biscoff Coffee Milkshake", price: "₹440", dietType: "veg" },
      { name: "Banana & Caramel Milkshake", price: "₹440", dietType: "veg" }
    ]
  },
  {
    id: "desserts",
