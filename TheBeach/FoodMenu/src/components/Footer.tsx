      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16 mb-14">
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <div className="flex gap-4">
            <a href="#" className="w-10 h-10 rounded-full border border-gold/50 flex items-center justify-center text-gold hover:bg-gold hover:text-background hover:border-gold transition-all duration-300" aria-label="Instagram">
              <Instagram size={17} />
            </a>
          </div>
        </div>
